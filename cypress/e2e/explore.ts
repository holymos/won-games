...
describe("Explore Page", () => {
  ...
  it("should render filter column", () => {
  ...
  it("should 15 games and show more games when show more button is clicked", () => {
  ...
  it("should return empty when no games match", () => {
    ...
    cy.findByRole("img", { name: /^a gamer in a couch/i }).should("exist");
    cy.findByText(/^no games were found/i).should("exist");
  });
});
