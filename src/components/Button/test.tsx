...
describe("<Button />", () => {
  ...
  it("should render the small size button if size prop is passed", () => {
  ...
  it("should render the full width version fullWidth prop is passed", () => {
