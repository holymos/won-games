...
describe("<PaymentForm />", () => {
  ...
  it("should call createPayment when it render and render free if get free games", async () => {
  ...
  it("should call createPayment when it render and render error if there's any issue", async () => {
